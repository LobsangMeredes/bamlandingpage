      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            <div className="text-custom-yellow mb-4">
              <FontAwesomeIcon icon={faDonate} size="3x" className="transition-transform duration-300 hover:scale-110" />
            </div>
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Donaciones de Libros</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
          ...
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Ventas Accesibles</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
          ...
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Eventos Educativos</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
          ...
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Programas de Alfabetización</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
          ...
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Colaboraciones y Proyectos Especiales</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
          ...
          <div className="bg-white bg-opacity-20 p-6 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
            ...
            <h3 className="text-xl font-bold mb-2 text-custom-yellow">Acceso Anticipado y Exclusivo</h3>
            <ul className="text-left list-disc list-inside space-y-2 text-custom-yellow">
